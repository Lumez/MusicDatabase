...
<div class = "mainBody">
	<h1>Add Performed Song</h1>
	<p><a href = "home.php">Back to Homepage</a></p>

	<?php 
		try {
			if (!isset($_POST['songID']) OR !isset($_POST['instrumentID']) OR !isset($_POST['musicianID']) OR empty($_POST['songID']) OR empty($_POST['instrumentID']) OR empty($_POST['musicianID'])) { 
